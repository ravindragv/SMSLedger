...
object TestConstants {
    fun getTestMessageSamples(): ArrayList<MessageSample> {
        val sampleMessages = ArrayList<MessageSample>()

        sampleMessages.add(
            MessageSample("Transaction Alert: INR 153.25 has been spent on your YES BANK " +
        ...
        sampleMessages.add(
            MessageSample("Thanks for using HDFC Bank Visa Giftcard III Y Card XXXX2222 " +
        ...
        sampleMessages.add(
            MessageSample("Dear Customer, INR 437.77 is debited on ICICI Bank Credit " +
        ...
        sampleMessages.add(
            MessageSample("Acct XX444 debited with INR 7,021.74 on 22-Oct-19.Info: " +
        ...
        sampleMessages.add(
            MessageSample("Dear Customer, your Account XX555 has been credited with " +
        ...
        sampleMessages.add(
            MessageSample("Dear Customer, your Account XX666 has been credited with " +
        ...
        sampleMessages.add(
            MessageSample("Your VPA batman@wayne linked to Indian Bank a/c no. " +
