...
object TestConstants {
    fun getTestMessageSamples(): ArrayList<SMSMessage> {
        val sampleMessages = ArrayList<SMSMessage>()

        sampleMessages.add(
            SMSMessage("Transaction Alert: INR 153.25 has been spent on your YES BANK " +
        ...
        sampleMessages.add(
            SMSMessage("Thanks for using HDFC Bank Visa Giftcard III Y Card XXXX2222 " +
        ...
        sampleMessages.add(
            SMSMessage("Dear Customer, INR 437.77 is debited on ICICI Bank Credit " +
        ...
        sampleMessages.add(
            SMSMessage("Acct XX444 debited with INR 7,021.74 on 22-Oct-19.Info: " +
        ...
        sampleMessages.add(
            SMSMessage("Dear Customer, your Account XX555 has been credited with " +
        ...
        sampleMessages.add(
            SMSMessage("Dear Customer, your Account XX666 has been credited with " +
        ...
        sampleMessages.add(
            SMSMessage("Your VPA batman@wayne linked to Indian Bank a/c no. " +
